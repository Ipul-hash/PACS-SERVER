...
module.exports = /*#__PURE__*/JSON.parse('{"name":"@ohif/extension-measurement-tracking","version":"3.13.0-beta.72","description":"Tracking features and functionality for basic image viewing","author":"OHIF Core Team","license":"MIT","repository":"OHIF/Viewers","main":"dist/ohif-extension-measurement-tracking.umd.js","module":"src/index.tsx","publishConfig":{"access":"public"},"engines":{"node":">=14","npm":">=6","yarn":">=1.18.0"},"files":["dist","README.md"],"keywords":["ohif-extension"],"scripts":{"clean":"shx rm -rf dist","clean:deep":"yarn run clean && shx rm -rf node_modules","dev":"cross-env NODE_ENV=development webpack --config .webpack/webpack.dev.js --watch --output-pathinfo","dev:dicom-pdf":"yarn run dev","build":"cross-env NODE_ENV=production webpack --config .webpack/webpack.prod.js","build:package-1":"yarn run build","start":"yarn run dev"},"peerDependencies":{"@cornerstonejs/core":"4.22.3","@cornerstonejs/tools":"4.22.3","@ohif/core":"3.13.0-beta.72","@ohif/extension-cornerstone-dicom-sr":"3.13.0-beta.72","@ohif/extension-default":"3.13.0-beta.72","@ohif/ui":"3.13.0-beta.72","classnames":"2.5.1","dcmjs":"0.49.4","lodash.debounce":"4.0.8","prop-types":"15.8.1","react":"18.3.1","react-dom":"18.3.1","webpack":"5.105.0","webpack-merge":"5.10.0"},"dependencies":{"@babel/runtime":"7.28.2","@ohif/ui":"3.13.0-beta.72","@xstate/react":"3.2.2","xstate":"4.38.3"}}');
