...
/* harmony import */ var _utils_getFilteredCornerstoneToolState__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utils/getFilteredCornerstoneToolState */ "../../../extensions/cornerstone-dicom-sr/src/utils/getFilteredCornerstoneToolState.ts");
/* harmony import */ var _utils_hydrateStructuredReport__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utils/hydrateStructuredReport */ "../../../extensions/cornerstone-dicom-sr/src/utils/hydrateStructuredReport.ts");
...
const _generateReport = (measurementData, additionalFindingTypes, options = {}) => {
  const filteredToolState = (0,_utils_getFilteredCornerstoneToolState__WEBPACK_IMPORTED_MODULE_3__["default"])(measurementData, additionalFindingTypes);
...
const commandsModule = props => {
  ...
  const actions = {
    ...
    hydrateStructuredReport: ({
      ...
      return (0,_utils_hydrateStructuredReport__WEBPACK_IMPORTED_MODULE_4__["default"])({
        servicesManager,
        extensionManager,
        commandsManager
      }, displaySetInstanceUID);
...
async function _load(srDisplaySet, servicesManager, extensionManager) {
  ...
  const displaySetsForSRPass = _ohif_core__WEBPACK_IMPORTED_MODULE_0__.utils.sortDisplaySetsCopy(displaySetService.activeDisplaySets, {
...
module.exports = /*#__PURE__*/JSON.parse('{"name":"@ohif/extension-cornerstone-dicom-sr","version":"3.13.0-beta.72","description":"OHIF extension for an SR Cornerstone Viewport","author":"OHIF","license":"MIT","repository":"OHIF/Viewers","main":"dist/ohif-extension-cornerstone-dicom-sr.umd.js","module":"src/index.tsx","engines":{"node":">=14","npm":">=6","yarn":">=1.16.0"},"files":["dist","README.md"],"publishConfig":{"access":"public"},"keywords":["ohif-extension"],"scripts":{"clean":"shx rm -rf dist","clean:deep":"yarn run clean && shx rm -rf node_modules","dev":"cross-env NODE_ENV=development webpack --config .webpack/webpack.dev.js --watch --output-pathinfo","dev:cornerstone":"yarn run dev","build":"cross-env NODE_ENV=production webpack --config .webpack/webpack.prod.js","build:package-1":"yarn run build","start":"yarn run dev","test:unit":"jest --watchAll","test:unit:ci":"jest --ci --runInBand --collectCoverage --passWithNoTests"},"peerDependencies":{"@ohif/core":"3.13.0-beta.72","@ohif/extension-cornerstone":"3.13.0-beta.72","@ohif/extension-measurement-tracking":"3.13.0-beta.72","@ohif/ui":"3.13.0-beta.72","dcmjs":"0.49.4","dicom-parser":"1.8.21","hammerjs":"2.0.8","prop-types":"15.8.1","react":"18.3.1"},"dependencies":{"@babel/runtime":"7.28.2","@cornerstonejs/adapters":"4.22.3","@cornerstonejs/core":"4.22.3","@cornerstonejs/tools":"4.22.3","classnames":"2.5.1"}}');
