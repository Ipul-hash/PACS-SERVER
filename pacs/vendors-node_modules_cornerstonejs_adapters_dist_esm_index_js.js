...
class Angle {
  ...
  static getMeasurementData(MeasurementGroup) {
    const {
      ...
      NUMGroup,
      SCOORDGroup
    } = _MeasurementReport_js__WEBPACK_IMPORTED_MODULE_2__["default"].getSetupMeasurementData(MeasurementGroup);
...
class Angle extends _BaseAdapter3D_js__WEBPACK_IMPORTED_MODULE_3__["default"] {
...
class ArrowAnnotate extends _BaseAdapter3D_js__WEBPACK_IMPORTED_MODULE_4__["default"] {
...
class BaseAdapter3D {
  ...
  static init(toolType, representation, options) {
    ...
    if (this.parentType) {
      this.trackingIdentifierTextValue = "".concat(_cornerstone3DTag_js__WEBPACK_IMPORTED_MODULE_0__["default"], ":").concat(this.parentType, ":").concat(this.toolType);
      const alternateTrackingIdentifier = "".concat(_cornerstone3DTag_js__WEBPACK_IMPORTED_MODULE_0__["default"], ":").concat(this.toolType);
      this.trackingIdentifiers.add(alternateTrackingIdentifier);
    } else {
      this.trackingIdentifierTextValue = "".concat(_cornerstone3DTag_js__WEBPACK_IMPORTED_MODULE_0__["default"], ":").concat(toolType);
    }
...
class Bidirectional extends _BaseAdapter3D_js__WEBPACK_IMPORTED_MODULE_6__["default"] {
  static getMeasurementData(MeasurementGroup, sopInstanceUIDToImageIdMap, metadata) {
    ...
    const longAxisNUMGroup = (0,_helpers_toArray_js__WEBPACK_IMPORTED_MODULE_3__.toArray)(ContentSequence).find(group => group.ConceptNameCodeSequence.CodeMeaning === LONG_AXIS);
    const shortAxisNUMGroup = (0,_helpers_toArray_js__WEBPACK_IMPORTED_MODULE_3__.toArray)(ContentSequence).find(group => group.ConceptNameCodeSequence.CodeMeaning === SHORT_AXIS);
    const longAxisScoordGroup = (0,_helpers_toArray_js__WEBPACK_IMPORTED_MODULE_3__.toArray)(longAxisNUMGroup.ContentSequence).find(group => group.ValueType === 'SCOORD3D' || group.ValueType === 'SCOORD');
    const shortAxisScoordGroup = (0,_helpers_toArray_js__WEBPACK_IMPORTED_MODULE_3__.toArray)(shortAxisNUMGroup.ContentSequence).find(group => group.ValueType === 'SCOORD3D' || group.ValueType === 'SCOORD');
    const worldCoords = [];
...
class CircleROI extends _BaseAdapter3D_js__WEBPACK_IMPORTED_MODULE_3__["default"] {
  static getMeasurementData(MeasurementGroup, sopInstanceUIDToImageIdMap, metadata) {
    const {
      state,
      NUMGroup,
...
class CobbAngle extends _BaseAdapter3D_js__WEBPACK_IMPORTED_MODULE_3__["default"] {
  static getMeasurementData(MeasurementGroup, sopInstanceUIDToImageIdMap, metadata) {
    const {
      state,
      NUMGroup,
      ...
      worldCoords,
      ReferencedFrameNumber
    } = _MeasurementReport_js__WEBPACK_IMPORTED_MODULE_2__["default"].getSetupMeasurementData(MeasurementGroup, sopInstanceUIDToImageIdMap, metadata, CobbAngle.toolType);
    state.annotation.data = _objectSpread(_objectSpread({}, state.annotation.data), {}, {
      handles: _objectSpread(_objectSpread({}, state.annotation.data.handles), {}, {
        points: [worldCoords[0], worldCoords[1], worldCoords[2], worldCoords[3]]
      }),
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ ControlPointPolyline)
/* harmony export */ });
/* harmony import */ var dcmjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! dcmjs */ "../../../node_modules/dcmjs/build/dcmjs.es.js");
/* harmony import */ var _constants_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./constants/index.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/adapters/Cornerstone3D/constants/index.js");



const {
  valueTypes
} = dcmjs__WEBPACK_IMPORTED_MODULE_0__.sr;
const {
  Polyline: TID300Polyline
} = dcmjs__WEBPACK_IMPORTED_MODULE_0__.utilities.TID300;
class ControlPointPolyline extends TID300Polyline {
  contentItem() {
    ...
    const scoordPlain = is3DMeasurement ? {
      ...
      ValueType: 'SCOORD3D',
      ConceptNameCodeSequence: [{
        CodeValue: _constants_index_js__WEBPACK_IMPORTED_MODULE_1__.CONTROL_POINTS_CODE.value,
        CodingSchemeDesignator: _constants_index_js__WEBPACK_IMPORTED_MODULE_1__.CONTROL_POINTS_CODE.schemeDesignator,
        CodeMeaning: _constants_index_js__WEBPACK_IMPORTED_MODULE_1__.CONTROL_POINTS_CODE.meaning
      }],
      GraphicType,
      GraphicData,
      ReferencedFrameOfReferenceUID,
    ...
    if (splineType) {
      const splineTypeObsContext = {
        ...
        ValueType: 'TEXT',
        ConceptNameCodeSequence: {
          CodeValue: _constants_index_js__WEBPACK_IMPORTED_MODULE_1__.SPLINE_TYPE_CODE.value,
          CodingSchemeDesignator: _constants_index_js__WEBPACK_IMPORTED_MODULE_1__.SPLINE_TYPE_CODE.schemeDesignator,
          CodeMeaning: _constants_index_js__WEBPACK_IMPORTED_MODULE_1__.SPLINE_TYPE_CODE.meaning
        },
...
const LENGTH = 'Length';
class Length extends _BaseAdapter3D_js__WEBPACK_IMPORTED_MODULE_3__["default"] {
  static getMeasurementData(MeasurementGroup, sopInstanceUIDToImageIdMap, metadata) {
    const {
      state,
      NUMGroup,
...
/* harmony import */ var _helpers_codeMeaningEquals_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../helpers/codeMeaningEquals.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/adapters/helpers/codeMeaningEquals.js");
...
const {
  TID1500,
  addAccessors
} = dcmjs__WEBPACK_IMPORTED_MODULE_1__.utilities;
const {
  StructuredReport
} = dcmjs__WEBPACK_IMPORTED_MODULE_1__.derivations;
const {
  Normalizer
} = dcmjs__WEBPACK_IMPORTED_MODULE_1__.normalizers;
const {
  TID1500MeasurementReport,
  TID1501MeasurementGroup
} = TID1500;
const {
  DicomMetaDictionary
} = dcmjs__WEBPACK_IMPORTED_MODULE_1__.data;
const FINDING = {
  CodingSchemeDesignator: 'DCM',
  CodeValue: '121071'
};
...
const CONTROL_POINTS = {
  CodingSchemeDesignator: _constants_index_js__WEBPACK_IMPORTED_MODULE_11__.CONTROL_POINTS_CODE.schemeDesignator,
  CodeValue: _constants_index_js__WEBPACK_IMPORTED_MODULE_11__.CONTROL_POINTS_CODE.value
};
const FINDING_SITE = {
  CodingSchemeDesignator: 'SCT',
  CodeValue: '363698007'
...
class MeasurementReport {
  ...
  static generateDatasetMeta() {
    return _constants_index_js__WEBPACK_IMPORTED_MODULE_11__.metaSRAnnotation;
  }
  ...
  static processSCOORD3DGroup(_ref2) {
    ...
    _cornerstonejs_core__WEBPACK_IMPORTED_MODULE_2__.utilities.updatePlaneRestriction((0,_helpers_toPoint3_js__WEBPACK_IMPORTED_MODULE_9__.toPoint3)(SCOORD3DGroup.GraphicData), toolData.state.annotation.metadata);
    return toolData;
  }
  static getSpatialCoordinatesState(_ref3) {
    ...
    const contentSequenceArr = (0,_helpers_toArray_js__WEBPACK_IMPORTED_MODULE_4__.toArray)(NUMGroup.ContentSequence);
  ...
  static processSpatialCoordinatesGroup(_ref4) {
    ...
    if (controlPointsGroup) {
      const controlPoints = (0,_helpers_scoordToWorld_js__WEBPACK_IMPORTED_MODULE_8__.scoordToWorld)({
        is3DMeasurement: !referencedImageId,
        referencedImageId
      }, controlPointsGroup);
  ...
  static getSetupMeasurementData(MeasurementGroup, sopInstanceUIDToImageIdMap, metadata, toolType) {
    ...
    const contentSequenceArr = (0,_helpers_toArray_js__WEBPACK_IMPORTED_MODULE_4__.toArray)(ContentSequence);
    ...
    if (!controlPointsGroup && NUMGroupForLookup !== null && NUMGroupForLookup !== void 0 && NUMGroupForLookup.ContentSequence) {
      controlPointsGroup = (0,_helpers_toArray_js__WEBPACK_IMPORTED_MODULE_4__.toArray)(NUMGroupForLookup.ContentSequence).find(item => this.codeValueMatch(item, CONTROL_POINTS));
    }
    ...
    return _objectSpread(_objectSpread({}, spatialGroup), {}, {
      is3DMeasurement,
      scoordArgs,
      scoord,
      worldCoords
  ...
  static generateReport(toolState, metadataProvider, options) {
    ...
    if (is3DSR) {
      ...
      if (!report.dataset.SOPClassUID) {
        throw new Error("NO sop class defined for Comprehensive3DSR in ".concat(JSON.stringify(DicomMetaDictionary.sopClassUIDsByName)));
      }
    }
    return report;
  }
  static generateToolState(dataset, sopInstanceUIDToImageIdMap, metadata, hooks) {
    ...
    const imagingMeasurementContent = (0,_helpers_toArray_js__WEBPACK_IMPORTED_MODULE_4__.toArray)(dataset.ContentSequence).find((0,_helpers_codeMeaningEquals_js__WEBPACK_IMPORTED_MODULE_5__.codeMeaningEquals)(REPORT));
    const measurementGroups = (0,_helpers_toArray_js__WEBPACK_IMPORTED_MODULE_4__.toArray)(imagingMeasurementContent.ContentSequence).filter((0,_helpers_codeMeaningEquals_js__WEBPACK_IMPORTED_MODULE_5__.codeMeaningEquals)(GROUP));
    const measurementData = {};
    measurementGroups.forEach(measurementGroup => {
      try {
        var _hooks$getToolClass;
        const measurementGroupContentSequence = (0,_helpers_toArray_js__WEBPACK_IMPORTED_MODULE_4__.toArray)(measurementGroup.ContentSequence);
        const trackingIdentifierGroup = measurementGroupContentSequence.find(contentItem => contentItem.ConceptNameCodeSequence.CodeMeaning === TRACKING_IDENTIFIER);
        const {
...
_MeasurementReport.CORNERSTONE_3D_TAG = _cornerstone3DTag_js__WEBPACK_IMPORTED_MODULE_3__["default"];
...
_MeasurementReport.generateDerivationSourceDataset = instance => {
  ...
  return _objectSpread(_objectSpread({}, studyTags), seriesTags);
};
...
/* harmony import */ var _BaseAdapter3D_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./BaseAdapter3D.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/adapters/Cornerstone3D/BaseAdapter3D.js");
/* harmony import */ var _metricHandler_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./metricHandler.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/adapters/Cornerstone3D/metricHandler.js");
/* harmony import */ var _helpers_toArray_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../helpers/toArray.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/adapters/helpers/toArray.js");
/* harmony import */ var dcmjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! dcmjs */ "../../../node_modules/dcmjs/build/dcmjs.es.js");
/* harmony import */ var _helpers_toScoordType_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../helpers/toScoordType.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/adapters/helpers/toScoordType.js");
...
/* harmony import */ var _ControlPointPolyline_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./ControlPointPolyline.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/adapters/Cornerstone3D/ControlPointPolyline.js");
...
class PlanarFreehandROI extends _BaseAdapter3D_js__WEBPACK_IMPORTED_MODULE_3__["default"] {
  static getMeasurementData(MeasurementGroup, sopInstanceUIDToImageIdMap, metadata) {
    ...
    const referencedSOPInstanceUID = state.sopInstanceUid;
    const allNUMGroups = (0,_metricHandler_js__WEBPACK_IMPORTED_MODULE_4__.extractAllNUMGroups)(MeasurementGroup, referencedSOPInstanceUID);
    const measurementNUMGroups = allNUMGroups[referencedSOPInstanceUID] || {};
    const SPLINE_TYPE = {
      CodingSchemeDesignator: _constants_index_js__WEBPACK_IMPORTED_MODULE_10__.SPLINE_TYPE_CODE.schemeDesignator,
      CodeValue: _constants_index_js__WEBPACK_IMPORTED_MODULE_10__.SPLINE_TYPE_CODE.value
    };
    const numSeq = NUMGroup ? (0,_helpers_toArray_js__WEBPACK_IMPORTED_MODULE_5__.toArray)(NUMGroup.ContentSequence) : [];
    const mgContentSeq = (0,_helpers_toArray_js__WEBPACK_IMPORTED_MODULE_5__.toArray)(MeasurementGroup.ContentSequence);
    const splineTypeItem = (_numSeq$find = numSeq.find(item => _MeasurementReport_js__WEBPACK_IMPORTED_MODULE_1__["default"].codeValueMatch(item, SPLINE_TYPE))) !== null && _numSeq$find !== void 0 ? _numSeq$find : mgContentSeq.find(item => _MeasurementReport_js__WEBPACK_IMPORTED_MODULE_1__["default"].codeValueMatch(item, SPLINE_TYPE));
    state.annotation.data = _objectSpread(_objectSpread({}, state.annotation.data), {}, {
      contour: {
    ...
    if (referencedImageId) {
      state.annotation.data.cachedStats = {
        ...
        }, (0,_metricHandler_js__WEBPACK_IMPORTED_MODULE_4__.restoreAdditionalMetrics)(measurementNUMGroups))
      };
    }
    return state;
  }
  static getTID300RepresentationArguments(tool) {
    ...
    const points = (0,_helpers_toScoordType_js__WEBPACK_IMPORTED_MODULE_7__.toScoords)(scoordProps, polyline);
    if (!isOpenContour) {
      const firstPoint = points[0];
      points.push(firstPoint);
    }
    const controlPoints = (handles === null || handles === void 0 || (_handles$points = handles.points) === null || _handles$points === void 0 ? void 0 : _handles$points.length) && (0,_helpers_toScoordType_js__WEBPACK_IMPORTED_MODULE_7__.toScoords)(scoordProps, handles.points);
    const {
      area,
      areaUnit,
      modalityUnit,
...
(() => {
  _PlanarFreehandROI.init('PlanarFreehandROI', _ControlPointPolyline_js__WEBPACK_IMPORTED_MODULE_9__["default"]);
...
class Probe extends _BaseAdapter3D_js__WEBPACK_IMPORTED_MODULE_3__["default"] {
...
/* harmony import */ var _utilities_getStructureSetModule_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./utilities/getStructureSetModule.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/adapters/Cornerstone3D/RTStruct/utilities/getStructureSetModule.js");
/* harmony import */ var _utilities_referencedMetadataProvider_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../utilities/referencedMetadataProvider.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/utilities/referencedMetadataProvider.js");
/* harmony import */ var _utilities_createInstance_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../utilities/createInstance.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/utilities/createInstance.js");
...
} = _cornerstonejs_tools__WEBPACK_IMPORTED_MODULE_2__.utilities.contours;
const {
  MetadataModules
...
async function generateRTSSFromLabelmap(segmentations, options) {
  ...
  const {
    metadataProvider = _cornerstonejs_core__WEBPACK_IMPORTED_MODULE_1__.metaData
  } = options;
  const roiContours = [];
  ...
  roiContours.forEach((contour, index) => {
    ...
    dataset.StructureSetROISequence.push((0,_utilities_getStructureSetModule_js__WEBPACK_IMPORTED_MODULE_6__["default"])(contour, segment));
    dataset.RTROIObservationsSequence.push((0,_utilities_getRTROIObservationsSequence_js__WEBPACK_IMPORTED_MODULE_5__["default"])(segment, index, options));
    dataset.ROIContourSequence.push(roiContour);
    dataset.ReferencedSeriesSequence = (0,_utilities_getReferencedSeriesSequence_js__WEBPACK_IMPORTED_MODULE_4__["default"])(dataset.ReferencedSeriesSequence, contour.metadata, options);
    dataset.ReferencedFrameOfReferenceSequence = (0,_utilities_getReferencedFrameOfReferenceSequence_js__WEBPACK_IMPORTED_MODULE_3__["default"])(dataset.ReferencedFrameOfReferenceSequence, contour.metadata);
  });
...
function generateRTSSFromAnnotations(segmentations, annotations, options) {
  ...
  annotations.forEach((annotation, index) => {
    ...
    if (!segmentAnnotation) {
      ...
      const structureSetModule = (0,_utilities_getStructureSetModule_js__WEBPACK_IMPORTED_MODULE_6__["default"])(annotation, segment);
      dataset.StructureSetROISequence.push(structureSetModule);
      dataset.RTROIObservationsSequence.push((0,_utilities_getRTROIObservationsSequence_js__WEBPACK_IMPORTED_MODULE_5__["default"])(segment, index, options));
      segmentAnnotation = _objectSpread(_objectSpread({}, segmentation), {}, {
        annotations: [],
        structureSetModule,
        segment,
    ...
    const roiContourSequence = AnnotationToPointData.convert(annotation, segmentAnnotation.segment, _cornerstonejs_core__WEBPACK_IMPORTED_MODULE_1__.metaData);
    ...
    dataset.ReferencedSeriesSequence = (0,_utilities_getReferencedSeriesSequence_js__WEBPACK_IMPORTED_MODULE_4__["default"])(dataset.ReferencedSeriesSequence, annotation.metadata, options);
    dataset.ReferencedFrameOfReferenceSequence = (0,_utilities_getReferencedFrameOfReferenceSequence_js__WEBPACK_IMPORTED_MODULE_3__["default"])(dataset.ReferencedFrameOfReferenceSequence, annotation.metadata);
  });
...
function _initializeDataset(segmentation, imgMetadata, options) {
  ...
  return (0,_utilities_createInstance_js__WEBPACK_IMPORTED_MODULE_8__.createInstance)(MetadataModules.RTSS_INSTANCE_DATA, studyExemplarImageId, {
    StructureSetLabel: segmentation.label,
    StructureSetName: segmentation.label,
    SeriesDescription: segmentation.label,
    _meta: _cornerstonejs_core__WEBPACK_IMPORTED_MODULE_1__.metaData.get(MetadataModules.RTSS_CONTOUR, studyExemplarImageId)
  }, options);
}
function generateRTSSFromContour(segmentations, options) {
  ...
  for (const annotationSet of annotationUIDsMap.values()) {
    for (const annotationUID of annotationSet.values()) {
      const annotation$1 = _cornerstonejs_tools__WEBPACK_IMPORTED_MODULE_2__.annotation.state.getAnnotation(annotationUID);
      if (!annotation$1) {
...
function getReferencedSeriesSequence(referencedSeriesSequence, metadata, options) {
  const metadataProvider = (options === null || options === void 0 ? void 0 : options.metadataProvider) || _cornerstonejs_core__WEBPACK_IMPORTED_MODULE_0__.metaData;
  const {
...
/* harmony import */ var dcmjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! dcmjs */ "../../../node_modules/dcmjs/build/dcmjs.es.js");
/* harmony import */ var _cornerstonejs_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @cornerstonejs/core */ "../../../node_modules/@cornerstonejs/core/dist/esm/index.js");
/* harmony import */ var _Cornerstone_Segmentation_4X_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../Cornerstone/Segmentation_4X.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/adapters/Cornerstone/Segmentation_4X.js");
...
function generateSegmentation(images, labelmaps, metadata) {
  ...
  const segmentationResult = (0,_Cornerstone_Segmentation_4X_js__WEBPACK_IMPORTED_MODULE_3__.fillSegmentation)(segmentation, labelmaps, options);
...
class UltrasoundDirectional extends _BaseAdapter3D_js__WEBPACK_IMPORTED_MODULE_4__["default"] {
  static getMeasurementData(measurementGroup, sopInstanceUIDToImageIdMap, metadata) {
    const {
      state,
      worldCoords,
...
/* harmony export */   CONTROL_POINTS_CODE: () => (/* binding */ CONTROL_POINTS_CODE),
...
/* harmony export */   SPLINE_TYPE_CODE: () => (/* binding */ SPLINE_TYPE_CODE),
...
const {
  DicomMetaDictionary
} = dcmjs__WEBPACK_IMPORTED_MODULE_2__["default"].data;
const {
  MetadataModules
} = _cornerstonejs_core__WEBPACK_IMPORTED_MODULE_1__.Enums;
...
const metadataProvider = {
  ...
  [MetadataModules.IMAGE_SOP_INSTANCE_REFERENCE]: function (imageId) {
    const frameModule = _cornerstonejs_core__WEBPACK_IMPORTED_MODULE_1__.metaData.get(MetadataModules.FRAME_MODULE, imageId);
    const {
      sopClassUID,
      sopInstanceUID,
      frameNumber,
  ...
  [MetadataModules.REFERENCED_SERIES_REFERENCE]: imageId => {
    const sopModule = _cornerstonejs_core__WEBPACK_IMPORTED_MODULE_1__.metaData.get(MetadataModules.SOP_COMMON, imageId);
    const seriesModule = _cornerstonejs_core__WEBPACK_IMPORTED_MODULE_1__.metaData.get(MetadataModules.GENERAL_SERIES, imageId);
    return {
  ...
  [MetadataModules.PREDECESSOR_SEQUENCE]: imageId => {
    const result = _objectSpread({}, _cornerstonejs_core__WEBPACK_IMPORTED_MODULE_1__.metaData.get(MetadataModules.SERIES_DATA, imageId));
    const generalImage = _cornerstonejs_core__WEBPACK_IMPORTED_MODULE_1__.metaData.get(MetadataModules.GENERAL_IMAGE, imageId);
    const study = _cornerstonejs_core__WEBPACK_IMPORTED_MODULE_1__.metaData.get(MetadataModules.GENERAL_STUDY, imageId);
  ...
  [MetadataModules.STUDY_DATA]: imageId => {
    return _cornerstonejs_core__WEBPACK_IMPORTED_MODULE_1__.metaData.getNormalized(imageId, STUDY_MODULES);
  },
  [MetadataModules.SERIES_DATA]: imageId => {
    return _cornerstonejs_core__WEBPACK_IMPORTED_MODULE_1__.metaData.getNormalized(imageId, SERIES_MODULES);
  },
  [MetadataModules.IMAGE_DATA]: imageId => {
    return _cornerstonejs_core__WEBPACK_IMPORTED_MODULE_1__.metaData.getNormalized(imageId, IMAGE_MODULES);
  },
  [MetadataModules.RTSS_INSTANCE_DATA]: imageId => {
    const newInstanceData = _cornerstonejs_core__WEBPACK_IMPORTED_MODULE_1__.metaData.get(MetadataModules.NEW_INSTANCE_DATA, imageId);
  ...
  [MetadataModules.NEW_INSTANCE_DATA]: imageId => {
    const studyData = _cornerstonejs_core__WEBPACK_IMPORTED_MODULE_1__.metaData.get(MetadataModules.STUDY_DATA, imageId);
  ...
  [MetadataModules.RTSS_CONTOUR]: () => _adapters_Cornerstone3D_constants_index_js__WEBPACK_IMPORTED_MODULE_3__.metaRTSSContour,
  [MetadataModules.SR_ANNOTATION]: () => _adapters_Cornerstone3D_constants_index_js__WEBPACK_IMPORTED_MODULE_3__.metaSRAnnotation
};
_cornerstonejs_core__WEBPACK_IMPORTED_MODULE_1__.metaData.addProvider(metadataProvider.get, 9023);
